...
public class Communication {
    ...
    {
        this.chipher = chiper;
        this.systemId = 1; // TODO : System id should be a String object as it is generated by java.util.UUID.randomUUID().toString() to avoid collisions (see jCHEKS_Concepts)
